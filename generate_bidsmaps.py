...
with open('raw_list.txt', 'w') as tmp_file:
...
with open('existing_bids.txt', 'w') as tmp_file:
...
with open('existing_d2b.txt', 'w') as tmp_file:
...
added = open('add-history_bids.txt','a')
added.write('\n\n\n' + str(datetime.datetime.now()) + '\n\n\n')
added.write('\n\n'.join(map(str,generated_bids)))
added.close()

added = open('add-history_d2b.txt','a')
added.write('\n\n\n' + str(datetime.datetime.now()) + '\n\n\n')
